...
export const Home = () => {
    ...
    <div className=" main-home ">
        ...
        <div className="bg-purper main-header row d-flex align-items-center">
            ...
            <div className="col-lg-5 col-sm-12 text-lg-end text-center row" style={{marginRight : "20px!important"}}>
                ...
                <h3 className="mt-3 col-lg-9 col-11 mx-auto mx-lg-0" style={{fontSize : "1.5em"}}>ورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد ت</h3>
            </div>
        </div>
        {/* separator header */}
        ...
        {/* Work samples */}
        <div className="position-relative border-purper-samples row d-flex justify-content-center overflow-hidden ">
    ...
    <defs>
        ...
        {/* footer */}
        <div className="overflow-hidden position-relative d-flex flex-column  justify-content-between align-items-center pt-5"  style={{ marginTop: '-251px' , top:'250px'}}>
