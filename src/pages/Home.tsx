...
export const Home = () => {
    ...
    const handelLocation =() =>
        {
            switch(stateLocation)
            {
                                ...
                                $(document).ready(()=>
                {
                    ...
                    // $(".header-img").animate({transform : translate(,) } , 1000);
    ...
    <div className=" main-home ">
        {/* header */}
        <div className="bg-purper main-header row " >
            <div className="col-lg-4 col-sm-12 header-images align-self-end">
            ...
            <div className="col-lg-8 col-12 align-items-center flex-column m-0 d-flex justify-content-center">
                <h1 className="font-title">سلام! من <strong>حامد رجبی فرجاد</strong> هستم </h1>
                <h3 className="mt-3 col-lg-9 col-11 mx-auto px-2 mx-lg-0 font-des"> خوش آمدید به رزومه‌ی من. اینجا مکانی است که تجربیات و دانش‌هایم را در زمینه‌های مختلف برنامه‌نویسی و توسعه وب  با شما به اشتراک می‌گذارم. امیدوارم که این اطلاعات برای شما مفید باشد.در صورت داشتن هر گونه سوال یا پیشنهاد، با من تماس بگیرید.</h3>
            </div>
        </div>
        {/* separator header */}
